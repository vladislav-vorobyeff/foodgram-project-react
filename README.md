...
Проект доступен по адресу: https://foodgramvlad.hopto.org
...
```
git clone https://github.com/vladislav-vorobyeff/foodgram-project-react.git
```
...
```
scp -r docs <username>@<ip host>@51.250.23.232:/home/<username>/
```
